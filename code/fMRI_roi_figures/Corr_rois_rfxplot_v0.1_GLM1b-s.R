#%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%#
# Corr_rois_rfxplot_v0.1_GLM14f.R                                          #
# Author: Yang Hu                                                          #
# Established Date: Dec. 14, 2018                                          #
...
myrfxplot <- function(GLM_label) { 
  ...
  ggsave(paste0(plot_savedir, rfxplot_name), width = 8, height = 5, dpi = 600)
...
for (i in 1:length(sheet_names)) {
  df_tmp = read_excel(paste0(rootdir,"data_roi/rfxreg/beta_ROI_rfxplot_long_GLM14f.xlsx"),
